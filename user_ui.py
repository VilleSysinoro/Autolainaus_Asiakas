...
"color: rgb(32, 75, 70);")
        ...
        self.keyBarcodeLineEdit.setGeometry(QRect(360, 310, 170, 45))
        font1 = QFont()
        font1.setFamilies([u"Trebuchet MS"])
        font1.setPointSize(22)
        font1.setBold(True)
        self.keyBarcodeLineEdit.setFont(font1)
        self.keyBarcodeLineEdit.setStyleSheet(u"background-color: rgb(213, 212, 207);\n"
"color: rgb(0, 0, 0);")
...
"color: rgb(255, 255, 255);")
        ...
        self.carInfoLabel.setGeometry(QRect(340, 370, 181, 71))
        font6 = QFont()
        ...
        font7.setBold(True)
        self.okPushButton.setFont(font7)
...
"color: rgb(255, 255, 255);")
        ...
        self.keyReturnBarcodeLineEdit.setGeometry(QRect(360, 310, 170, 45))
        self.keyReturnBarcodeLineEdit.setFont(font1)
        self.keyReturnBarcodeLineEdit.setStyleSheet(u"background-color: rgb(213, 212, 207);\n"
"color: rgb(0, 0, 0);")
        ...
        self.statusFrame.setGeometry(QRect(10, 100, 1081, 391))
...
"")
        ...
        self.inUsePlainTextEdit.setGeometry(QRect(490, 60, 571, 331))
...
"border-color: rgb(255, 255, 255);")
        ...
        self.soundCheckBox.setGeometry(QRect(1170, 10, 81, 61))
        font10 = QFont()
...
"")
        ...
        self.vehiclePictureLabel.setGeometry(QRect(270, 470, 341, 241))
        self.vehiclePictureLabel.setPixmap(QPixmap(u"uiPictures/OXZ915.png"))
        self.vehiclePictureLabel.setScaledContents(True)
        self.registerPlateLabel = QLabel(self.centralwidget)
        self.registerPlateLabel.setObjectName(u"registerPlateLabel")
        self.registerPlateLabel.setGeometry(QRect(321, 297, 231, 71))
        self.registerPlateLabel.setPixmap(QPixmap(u":/pictures/uiPictures/Auton_matala_EU-kilpi_118x442_mm.png-removebg-preview.png"))
        self.registerPlateLabel.setScaledContents(True)
        self.rasekoLogoLabel = QLabel(self.centralwidget)
        self.rasekoLogoLabel.setObjectName(u"rasekoLogoLabel")
        self.rasekoLogoLabel.setGeometry(QRect(1270, 10, 91, 151))
        self.rasekoLogoLabel.setPixmap(QPixmap(u":/pictures/uiPictures/raseko_logo_pysty-b27c909bbc.png"))
...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.keyBarcodeLineEdit.setText(QCoreApplication.translate("MainWindow", u"XUX-682", None))
        self.keyBarcodeLineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Lue avain", None))
#if QT_CONFIG(tooltip)
        self.takeCarPushButton.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:11pt;\">Avaa auton lainaus ikkunan</span></p></body></html>", None))
...
#if QT_CONFIG(tooltip)
        self.returnCarPushButton.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Avaa auton palautus ikkunan</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.keyReturnBarcodeLineEdit.setText(QCoreApplication.translate("MainWindow", u"XUX-682", None))
        ...
        self.registerPlateLabel.setText("")
        self.rasekoLogoLabel.setText("")
